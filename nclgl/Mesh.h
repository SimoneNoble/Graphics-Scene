...
public:
	...
	void GenerateNormals(); // not sure if belongs here
	bool GetVertexIndicesForTri(unsigned int i, unsigned int& a, unsigned int& b, unsigned int& c) const; // not sure if belongs here
